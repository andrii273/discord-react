            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  Providing tailored and comprehensive solutions for clients across diverse industries worldwide.
                </p>
                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                  <li>
                    <Link
                      href="https://bitscaled.refined.site/portal/3?createRequest=true&portalId=3&requestTypeId=34"
                ...
                <div>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    Bitscaled LLC is a registered company in the United States.
                  </p>
                  <div
                  ...
                  >
                    <a
                      href="https://www.linkedin.com/company/bitscaled"
